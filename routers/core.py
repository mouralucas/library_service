...
@router.get("/language")
async def get_language(session: AsyncSession = Depends(get_session)) -> GetLanguageResponse:
...
async def create_country(country: CreateCountryRequest,
                         session: AsyncSession = Depends(get_session)) -> CreateCountryResponse:
...
@router.get("/country")
async def get_country(session: AsyncSession = Depends(get_session)) -> GetCountryResponse:
...
async def create_serie(serie: CreateSerieRequest,
                       session: AsyncSession = Depends(get_session)) -> CreateSerieResponse:
...
async def create_collection(collection: CreateCollectionRequest,
                            session: AsyncSession = Depends(get_session)) -> CreateCollectionResponse:
...
async def get_collection(session: AsyncSession = Depends(get_session)) -> GetCollectionResponse:
...
async def create_publisher(publisher: CreatePublisherRequest,
                           session: AsyncSession = Depends(get_session)) -> CreatePublisherResponse:
...
async def get_publisher(session: AsyncSession = Depends(get_session)) -> GetPublisherResponse:
