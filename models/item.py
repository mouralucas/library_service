...
class ItemModel(SQLModel):
    ...
    serie: Mapped["SerieModel"] = relationship(foreign_keys=[serie_id], lazy="noload")  # noqa: F821
...
class UserItemEditionModel(SQLModel):
    ...
    status: Mapped[list["StatusModel"]] = relationship(
        "StatusModel", secondary="user_item_edition_status", lazy="noload", viewonly=True
    )
