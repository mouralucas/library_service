    ...
    progress: list[dict[str, Any]] = [
        {
            **default_model_dict,
            ...
            "progress_date": get_timestamp_aware() - relativedelta(days=25),
            "page": 37,
            "percentage": 10,
        },
        {
            **default_model_dict,
            ...
            "reading_id": active_reading[0]["id"],
            "item_id": active_reading[0]["item_id"],
            "progress_date": get_timestamp_aware() - relativedelta(days=20),
            "page": 74,
            "percentage": 20,
        },
        {
            **default_model_dict,
            ...
            "reading_id": active_reading[0]["id"],
            "item_id": active_reading[0]["item_id"],
            "progress_date": get_timestamp_aware() - relativedelta(days=15),
            "page": 111,
            "percentage": 30,
        },
    ]
