...
class ItemSchema(BaseModel):
    ...
    main_author_name: str | None = Field(None, description='The name of the main author')
    ...
    title_original: str | None = Field(None, description="The original title of the item")
    subtitle_original: str | None = Field(None, description="The original title of the item")
    ...
    publication_date: datetime.date | None = Field(None, description='The date of publication of the item')
    original_publication_date: datetime.date | None = Field(None, description='The original date of publication')
    ...
    format: str | None = Field(None, serialization_alias='formatId', description='The format of the item')
