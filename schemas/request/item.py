...
class CreateItemRequest(BaseModel):
    ...
    publication_date: datetime.date = Field(None, alias='publishDate', description='The date of the publish')
    original_publication_date: datetime.date = Field(None, alias='originalPublishDate', description='The date of the publish')
