...
class CreateLanguageResponse(BaseModel):
    language: LanguageSchema = Field(
        ..., serialization_alias="language", description="The language created"
    )
...
class GetLanguageResponse(BaseModel):
    ...
    languages: list[LanguageSchema] = Field(
        ..., serialization_alias="languages", description="The languages available"
    )


class CreateCountryResponse(BaseModel):
    country: CountrySchema = Field(
        ..., serialization_alias="country", description="The country created"
    )
...
class GetCountryResponse(BaseModel):
    ...
    countries: list[CountrySchema] = Field(
        ..., serialization_alias="countries", description="The countries available"
    )


class CreateSerieResponse(BaseModel):
    serie: SerieSchema = Field(
        ..., serialization_alias="serie", description="The serie created"
    )


class GetSeriesResponse(BaseModel):
    quantity: int = Field(..., description="The quantity of series available")
    series: list[SerieSchema] = Field(
        ..., serialization_alias="series", description="The series available"
    )


class CreateCollectionResponse(BaseModel):
    collection: CollectionSchema = Field(
        ..., serialization_alias="collection", description="The collection created"
    )
...
class GetCollectionResponse(BaseModel):
    ...
    collections: list[CollectionSchema] = Field(
        ..., serialization_alias="collections", description="The collections available"
    )
...
class GetPublisherResponse(BaseModel):
    ...
    publishers: list[PublisherSchema] = Field(
        ..., description="The publishers available"
    )
...
class GetStatusResponse(BaseModel):
    ...
    statuses: list[StatusSchema] = Field(
